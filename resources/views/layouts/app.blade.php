        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3"><small class="h5">{{ config('app.name', 'Laravel') }}</small></div>
                </a>
                <!-- Divider -->
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <ul class="navbar-nav ml-auto">
                                    ...
                                    @foreach(Auth::user()->unreadNotifications as $notification)
                                        <a class="dropdown-item d-flex align-items-center" href="{{$notification->data['url']}}">
                                            <div class="font-weight-bold">
                                                ...
                                                <div class="small text-gray-500">{{$notification->data['message']}} <br />{{$notification->created_at}}</div>
                                            </div>
                                        </a>
                                    @endforeach
                                </div>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <img class="img-profile rounded-circle" src="{{asset('design/dist/images/test1.jpg')}}">
                                </a>
